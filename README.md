...
1. [问一下各位大佬，云计算和前端选择哪个？云计算就是运维嘛。。。](https://www.v2ex.com/t/871043) `22条评论` `问与答`
...
1. [最近忽然有种感觉， web2 的应用逐渐在腐朽崩塌，但新的应用形式是什么样，又还看不清楚。不知道大家有什么想法吗，可以一起来说说呀。现存的痛点究竟是什么，我们该怎么建设出一个更好的？](https://www.v2ex.com/t/871064) `17条评论` `程序员`
...
1. [tplink mesh 组网怎么让电视固定连接其中一个路由器呢？](https://www.v2ex.com/t/871072) `8条评论` `宽带症候群`
1. [这种明知后果接受不了，明知会后悔，可当时还是不好好学不认真学的情况避免不了吗？](https://www.v2ex.com/t/871066) `8条评论` `问与答`
1. [移动宽带使用西部世界的问题](https://www.v2ex.com/t/871035) `8条评论` `问与答`
1. [go 泛型以后会支持特例化吗](https://www.v2ex.com/t/871042) `7条评论` `Go 编程语言`
1. [相亲都是要见一两次面后就决定双方关系吗？](https://www.v2ex.com/t/871076) `6条评论` `问与答`
1. [问下上海漕河泾这边 字节 和腾讯 房补多少呀？](https://www.v2ex.com/t/871067) `6条评论` `问与答`
1. [求一个 PHP 文件，支持断点续传](https://www.v2ex.com/t/871022) `6条评论` `问与答`

数据更新于 2022-08-06 06:23:12
