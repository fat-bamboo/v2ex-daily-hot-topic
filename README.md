...
1. [起步 PHP ，用了近 2 年 go，开发经验 7 年。目前在一家小公司负责研发，目前项目因为人力用 PHP 开发，纠结重构用 go 还是 Java ，目前三线城市 Java 岗位多出于这个原因，大家有什么好的建议](https://www.v2ex.com/t/985519) `28条评论` `程序员`
...
1. [冒死分析：不能访问自己的 SLB 是一个坏设计](https://www.v2ex.com/t/985534) `6条评论` `云计算`
1. [Win11 当前是用微软账户登录，安装软件，创建环境的，那么是不是其它 Win 系统的 PC 机就不能远程桌面到这个用户环境来使用了？](https://www.v2ex.com/t/985521) `6条评论` `Windows`

数据更新于 2023-10-26 02:35:49
