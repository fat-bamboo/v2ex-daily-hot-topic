...
1. [小镇青年，选择考公回县城还是跳槽去大城市？](https://www.v2ex.com/t/1023872) `11条评论` `问与答`
...
1. [调研了一下 Jellyfin 服务器硬件，当前最优解有点出乎我的意料](https://www.v2ex.com/t/1023877) `8条评论` `NAS`
1. [如果语料库是资源，掌握用户聊天信息的微信会拿这些去炼丹吗](https://www.v2ex.com/t/1023841) `8条评论` `问与答`
1. [人工智能（AI）井喷式发展下，未来“程序员”这个职业会不存在吗？](https://www.v2ex.com/t/1023860) `7条评论` `程序员`
1. [8000 以内笔记本求推荐](https://www.v2ex.com/t/1023852) `7条评论` `问与答`
1. [AS9 续航突然尿崩](https://www.v2ex.com/t/1023825) `7条评论` ` WATCH`
1. [Body 传参时，有没有必要将查询参数用一个字段包起来](https://www.v2ex.com/t/1023889) `6条评论` `程序员`
1. [介于年久失修以及 Chrome 马上不能支持 v2 版本插件，所以重写了 Switchy Omega 的功能](https://www.v2ex.com/t/1023873) `6条评论` `分享发现`

数据更新于 2024-03-15 03:18:46
