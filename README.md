...
1. [住宿舍的大学生是否需要一台 nas ？](https://www.v2ex.com/t/1030069) `52条评论` `NAS`
...
1. [2024 Windows 日常软件推荐](https://www.v2ex.com/t/1030062) `24条评论` `Windows`
...
1. [[求助] 服务端开发 MacBook 选购建议](https://www.v2ex.com/t/1030073) `17条评论` `程序员`
...
1. [有没有了解 paddleocr 的 V 友，我用 Flask 写了个简易 API，内存占用会越来越大， 4~6 个小时就把机器 64GB 内存占满了，只能用 cron 每小时重启，是内存泄露的问题吗](https://www.v2ex.com/t/1030071) `13条评论` `Python`
