...
1. [苹果为什么不做指纹](https://www.v2ex.com/t/1008120) `108条评论` `Apple`
...
1. [Java 应用内存不断增长](https://www.v2ex.com/t/1007983) `58条评论` `Java`
...
1. [NAS 组建问题，该选择 NAS 专用的机箱还是选择塔式机箱？是选择用 n/j 系列还是选择低功耗的 cpu？](https://www.v2ex.com/t/1008209) `24条评论` `NAS`
...
1. [vaultwarden 备份思路](https://www.v2ex.com/t/1008203) `20条评论` `奇思妙想`
