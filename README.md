...
1. [目前主流虚拟化为啥不支持克隆完整开机状态的虚拟机？](https://www.v2ex.com/t/884401) `14条评论` `Linux`
...
1. [自己的 Ubuntu Server 输入关机命令后，并没有真的关机，为什么呢？](https://www.v2ex.com/t/884404) `12条评论` `程序员`
...
1. [今天听说一个玄学算法，写了一下，确实玄学？](https://www.v2ex.com/t/884426) `9条评论` `程序员`
1. [自己搭建的 NAS，放假回老家后发现访问不了了](https://www.v2ex.com/t/884413) `9条评论` `问与答`

数据更新于 2022-10-02 17:40:35
