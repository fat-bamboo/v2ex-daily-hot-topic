...
1. [各位，如果让你推荐 3 本书，你会推荐哪 3 本啊](https://www.v2ex.com/t/974506) `97条评论` `分享发现`
1. [为什么舍不得花 1 天的税前买心爱的电脑](https://www.v2ex.com/t/974547) `42条评论` `问与答`
1. [我用以下方法证明了 如果用 homebrew 装软件，就卸载不干净了？](https://www.v2ex.com/t/974517) `40条评论` `程序员`
1. [[号码泄露]静默三年的手机卡的副号，绑定云上贵州的第三天凌晨收到诈骗短信](https://www.v2ex.com/t/974527) `39条评论` `iCloud`
1. [iPhone 15 买什么壳，介绍一下买壳经验](https://www.v2ex.com/t/974514) `33条评论` `iPhone`
1. [目前支持 OpenWrt 兼容性最好的路由器是哪款？](https://www.v2ex.com/t/974570) `17条评论` `OpenWrt`
1. [就 web 爬虫来说， scrapy， selenium 之类的爬虫框架和自己用 chrome 扩展做爬虫有啥区别？](https://www.v2ex.com/t/974592) `14条评论` `程序员`
...
1. [求证实，虽然经常被夸大，经过对比测试发现安卓内存确实没有 iPhone 的耐用，这个对比是否科学？](https://www.v2ex.com/t/974608) `11条评论` `问与答`
...
1. [想重拾英语，如何下手？](https://www.v2ex.com/t/974603) `10条评论` `程序员`
1. [求推荐后端发展方向](https://www.v2ex.com/t/974598) `9条评论` `程序员`
...
1. [CTF 比赛：有 PHP 大佬可以帮指点下关于 scandir 的问题吗](https://www.v2ex.com/t/974590) `7条评论` `PHP`
1. [懂 graalvm、spring-native 的来聊一聊，目前这技术感觉还不够成熟](https://www.v2ex.com/t/974583) `7条评论` `程序员`

数据更新于 2023-09-17 11:25:54
