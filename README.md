...
1. [公司不配电脑，也没有补贴](https://www.v2ex.com/t/785769) `59条评论` `职场话题`
1. [小公司都是怎么部署代码到生产环境服务器的？](https://www.v2ex.com/t/785777) `59条评论` `程序员`
...
1. [官翻的 Macmini，选 256 还是 512G?](https://www.v2ex.com/t/785806) `22条评论` `Apple`
1. [都说 go 挺好使的，准备用 go 写几个接口](https://www.v2ex.com/t/785787) `22条评论` `Go`
1. [续：《浏览器关闭最后一个标签页后的行为》，写了个插件试图找回当年用世界之窗的感觉～](https://www.v2ex.com/t/785786) `20条评论` `程序员`
1. [每个月需要多少流量能够 99%完全满足你所有设备的需求，甚至不用宽带？](https://www.v2ex.com/t/785780) `19条评论` `问与答`
