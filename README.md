...
1. [最强 AI 字幕软件来了， V2sub - AI 字幕机（原创软件）](https://www.v2ex.com/t/930940) `33条评论` `分享创造`
...
1. [知识付费 = 割韭菜 ？](https://www.v2ex.com/t/930987) `12条评论` `程序员`
1. [帮忙测试下服务器防御能力](https://www.v2ex.com/t/930967) `12条评论` `宽带症候群`
1. [有必要在海量长连接场景使用第三方网络库吗?](https://www.v2ex.com/t/930943) `12条评论` `程序员`
1. [能不能用 SQL 查出没有在数据表里出现的值](https://www.v2ex.com/t/930970) `11条评论` `问与答`
...
1. [伸手： Java 有没有哪个注解可以在编译时插入当前时间，我想在代码里直接得到编译时间🤔](https://www.v2ex.com/t/930978) `7条评论` `Java`
