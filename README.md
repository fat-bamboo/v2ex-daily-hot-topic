...
1. [计算机大二发展规划，放弃 Java ,以 Python ， go 为技术栈发展可以吗，老哥们帮看看给点建议呗](https://www.v2ex.com/t/753564) `68条评论` `程序员`
1. [奥迪 Q3 四驱，后轮行驶过程中抱死，过年回家差点让我跟老婆孩子 GameOver，记录维权过程](https://www.v2ex.com/t/753572) `52条评论` `汽车`
...
1. [哪个 app 能保存推特上的视频？](https://www.v2ex.com/t/753518) `30条评论` `iPhone`
...
1. [特斯拉为什么火？](https://www.v2ex.com/t/753593) `17条评论` `汽车`
...
1. [求助帖： mac 不小心被远程抹除了，因为电脑上还有论文等重要数据，想看看大家有没有什么办法恢复？谢谢了🙏PS:电脑是 18 年带 T2 芯片的 macbook air😓](https://www.v2ex.com/t/753600) `14条评论` `macOS`
1. [[求助] 折腾了一天的软路由没弄明白](https://www.v2ex.com/t/753594) `13条评论` `问与答`
...
1. [冷存大量浮点数类型数据，有什么合适的压缩方案吗？](https://www.v2ex.com/t/753590) `12条评论` `问与答`
1. [csdn 竟然搞了个 GitHub 的镜像？](https://www.v2ex.com/t/753571) `12条评论` `分享发现`
1. [光猫能获取路由的 WiFi 配置？](https://www.v2ex.com/t/753584) `11条评论` `宽带症候群`
1. [学术论文里的程序使用了 GPL 协议的开源代码，是否可以找作者要源代码？](https://www.v2ex.com/t/753493) `11条评论` `程序员`

数据更新于 2021-02-16 16:01:57
