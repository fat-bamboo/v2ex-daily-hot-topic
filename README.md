...
1. [一天大概会生成七八千量的订单数据，逐一去调用第三方支付接口支付。已有逻辑是使用定时任务同步执行的，每 5 秒执行一次，需要执行几个小时才能完成。怎么改造一下能快速处理完？](https://www.v2ex.com/t/767528) `12条评论` `问与答`
1. [抄 JD 的公司是什么操作?](https://www.v2ex.com/t/767486) `11条评论` `职场话题`
1. [听听大伙们对沪/杭薪酬分析](https://www.v2ex.com/t/767454) `11条评论` `程序员`
1. [迫于女朋友，求一个合适的免息分期方案](https://www.v2ex.com/t/767538) `10条评论` `iPhone`
1. [好哥哥们给个建议，黑 NUC 还是 macmini18?](https://www.v2ex.com/t/767532) `10条评论` `Apple`
1. [快来个 React H5（看好了不是 RN）精通的小伙伴，一起参与兼职项目。](https://www.v2ex.com/t/767520) `10条评论` `React`
1. [补发个帖子：打车公司的云，推测是要停止公有云业务了](https://www.v2ex.com/t/767497) `10条评论` `云计算`

数据更新于 2021-04-02 06:42:56
