...
1. [真的有公司搞 devops 吗？成功了吗？](https://www.v2ex.com/t/792410) `53条评论` `程序员`
...
1. [最近用几行 SVG 重构了一个之前用 Canvas 写了很多的动画，这里是一篇 SVG 的小分享~](https://www.v2ex.com/t/792457) `12条评论` `分享创造`
...
1. [python3 项目不改代码前提下，有什么办法可以把引用的 mysqlclient 直接替换为 PyMySQL？](https://www.v2ex.com/t/792453) `9条评论` `Python`
