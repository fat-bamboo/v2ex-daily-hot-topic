...
1. [利用机器学习训练分类好的 k 线图，能否识别股市涨跌？](https://www.v2ex.com/t/799974) `55条评论` `程序员`
1. [V 友们，你们平时有在使用 IPV6 吗？](https://www.v2ex.com/t/799942) `28条评论` `宽带症候群`
1. [给某个程序断网](https://www.v2ex.com/t/799940) `27条评论` `Windows`
...
1. [微信迁移 wechat 的朋友注意了， 转到 wechat 就无法登录网页版微信了， fuck](https://www.v2ex.com/t/799959) `21条评论` `微信`
...
1. [M1 8G 内存对 Java 开发够用吗？](https://www.v2ex.com/t/799988) `17条评论` `MacBook`
1. [MySQL 数据库主键用了字符串的 UUID 怎么办？](https://www.v2ex.com/t/799982) `14条评论` `MySQL`
1. [在 A 股，你觉得散户赚钱的比例有多少，欢迎讨论！](https://www.v2ex.com/t/799992) `12条评论` `投资`
...
1. [有 UE4 大神没，想问个问题。](https://www.v2ex.com/t/799978) `7条评论` `Unreal Development Kit`
...
1. [能不能通过远程桌面使用服务器上安装的软件来调试与客户端串口连接的外设](https://www.v2ex.com/t/799985) `6条评论` `问与答`

数据更新于 2021-09-05 14:06:09
