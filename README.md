...
1. [突然发现 VSCode 完全比不上 Jetbrain 全家桶](https://www.v2ex.com/t/804121) `87条评论` `Visual Studio Code`
1. [CTO 是做 Java 的，然而技术选项却选了 rails](https://www.v2ex.com/t/804097) `42条评论` `Java`
...
1. [写了一个基于 DirectX 的 Ethereum 挖矿程序， 可以部署到 XBox Series X/S 上, 求 star~](https://www.v2ex.com/t/804173) `13条评论` `分享创造`
