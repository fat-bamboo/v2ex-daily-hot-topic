...
1. [[没想到轮到我了] 京东购买苹果电脑，发错颜色拒不承认](https://www.v2ex.com/t/956728) `89条评论` `Apple`
1. [Mac 脑瘫设计吐槽（100%主观）](https://www.v2ex.com/t/956671) `88条评论` `Apple`
...
1. [新手求问，手头只有一台 m 芯片的 Mac，如何把一个非常简短的 Python 脚本做成一个可以在 x86_64 win10 上运行的可执行文件？](https://www.v2ex.com/t/956844) `32条评论` `Python`
