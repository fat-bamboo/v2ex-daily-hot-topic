...
1. [Safari 和 Webkit 团队终于承认错误并开始征求反馈](https://www.v2ex.com/t/833117) `78条评论` `Apple`
...
1. [一个人（公司摸鱼+业余时间）开发了五年的开源项目：可用于自建 Git 服务，自带看板和 CI/CD，可替代 GitHub/GitLab（功能级的替代，而非小而美）](https://www.v2ex.com/t/833320) `38条评论` `程序员`
...
1. [小区还可以这样管？真的被震撼到了。](https://www.v2ex.com/t/833300) `24条评论` `生活`
