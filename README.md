...
1. [观国产操作系统贴有感](https://www.v2ex.com/t/896716) `83条评论` `程序员`
1. [存在这样的工作吗？](https://www.v2ex.com/t/896711) `66条评论` `问与答`
1. [今早闹钟没响引发了我对闹钟的信任危机](https://www.v2ex.com/t/896693) `57条评论` `Apple`
...
1. [听说 HK 上下对等很久了，个别地区也推出了 3000 下 1000 上的带宽，请问你那边的大宽带网是哪家还有费用是怎样子的呢？](https://www.v2ex.com/t/896733) `23条评论` `宽带症候群`
...
1. [一个非常奇怪的问题， supervisord 启动的用 aiohttp 发请求的爬虫同时发 10 万请求的情况下有大约 30%的请求会无法解析域名，而在 bash 中手动运行则没有这个问题， Google 上没找到一个类似情况的](https://www.v2ex.com/t/896755) `12条评论` `Python`
1. [前端学习后端，语言选择](https://www.v2ex.com/t/896745) `9条评论` `程序员`
1. [求推荐提供 gpu 计算租赁的平台](https://www.v2ex.com/t/896737) `8条评论` `云计算`
1. [第一次关注到工资怎么结算](https://www.v2ex.com/t/896736) `8条评论` `分享发现`
1. [我的 iPhone 13 和 AirPods Pro 有点不搭。。](https://www.v2ex.com/t/896728) `8条评论` `Apple`
